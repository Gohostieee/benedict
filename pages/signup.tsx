            ...
            <main className={"z-10 relative flex flex-col h-[100vh] justify-center"}>
                ...
                <div className={"w-[500px] h-[500px] border bg-black bg-opacity-80 m-auto flex flex-col"}>
                    ...
                    <div className={"m-auto w-[40%] "}>
                        ...
                        <button className={"border bg-transparent w-[100%] m-auto h-16 text-white text-3xl font-bold hover:bg-rose-900 hover:font-thin hover:text-2xl transition-all"}>Signup</button>
