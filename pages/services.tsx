                ...
                <div className='w-[90vw] m-auto overflow- block'>
                    ...
                    <div className='top-48 relative border p-4 bg-black bg-opacity-70 flex'>
                        ...
                        <p className='text-white text-2xl mt-4 mb-4 font-thin border-x p-2 m-4'>
                            TLDR: Sharing documents, particularly things like excel docs, suck, large documents are very taxing on the system, and some guys just ain't
                    ...
                    <div className='top-48 mt-12 relative border p-4 bg-black bg-opacity-70 flex'>
                        ...
                        <p className='text-white text-2xl mt-4 mb-4 font-thin border-x p-2 m-4'>
                            ...
                            or something later. <a href={"/teaching"} className={"text-pink-600 underline underline-offset-4"}><br/>Come here and feed me!</a>
                        </p>
                    ...
                    <div className='top-48 mt-12 relative border p-4 bg-black bg-opacity-70 flex'>
                        ...
                        <p className='text-white text-2xl mt-4 mb-4 font-thin border-x p-2 m-4'>
                            ...
                            weird man), so I'm probably going to do that, I'm not doing it right now, but ya know, maybe in like a week, it's not that hard yk? <a href={"/account"} className={"text-green-600 underline-offset-4 underline"}><br/> Go check out your account, make it SPICY</a>
                        </p>
